...
function [sol, iter_true ] = PGM(Q,q,epsilon,C,lambda_0,N, max_iter,tol)
    ...
    disp('----------------------------------------------------');
    [lambda_n,f_min, norma, alpha]=projection_routine(Q,q,lambda_0,anti_grad,N,epsilon,C,tol, isin_border);
    ...
    while norma>epsilon % condizione terminazione
       ...
       [lambda_n,f_min, norma, alpha]=projection_routine(Q,q,lambda_n,anti_grad,N,epsilon,C,tol, isin_border);
